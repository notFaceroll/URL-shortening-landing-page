...
export default function Features(props) {
  return (
    <section className="p-8 text-center bg-neutral-100 flex flex-col gap-12 -mt-10">
      ...
      <div className="flex flex-col sm:flex-row gap-8 items-center after:absolute after:-bottom-2/3 sm:after:-bottom-16 sm:after:left-80 z-0 after:h-1/2 after:w-1 sm:after:h-1 sm:after:w-1/2 after:bg-primary-cyan">
        <Card>
          <Icon icon={FirstIcon} />
